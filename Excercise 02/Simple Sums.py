...
# Second Integer.
Integer2 = 10
# The Variable where the calculation is preformed of First and Second Variables where the Integers are stored.
Addition = (Integer1 + Integer2)
# The output of the Variable where the sum of two variables are stored.
print(Addition)
